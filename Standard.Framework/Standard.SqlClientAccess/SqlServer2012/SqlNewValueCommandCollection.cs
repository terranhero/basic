...
namespace Basic.SqlServer2012
{
	...
	internal sealed class SqlNewValueCommandCollection : NewValueCommandCollection
	{
		...
		public SqlNewValueCommandCollection(SqlStaticCommand staticCommand) : base(staticCommand) { dbStaticCommand = staticCommand; }
		...
		public SqlNewValueCommandCollection(SqlStaticCommand staticCommand, IList<NewValueCommand> list)
		...
		{
			return new SqlNewValueCommand(dbStaticCommand);
		}
	}
}
