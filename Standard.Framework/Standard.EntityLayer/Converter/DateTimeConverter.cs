...
namespace Basic.EntityLayer
{
	...
	public sealed class DateTimeConverter : System.ComponentModel.DateTimeConverter
    {
        ...
        /// 获取系统最小日期
        /// </summary>
        public static DateTime MinValue { get { return new DateTime(1900, 1, 1, 0, 0, 0, DateTimeKind.Unspecified); } }

        /// <summary>
        /// 获取系统最大日期
        /// </summary>
        public static DateTime MaxValue { get { return new DateTime(2499, 12, 31, 23, 59, 59, DateTimeKind.Unspecified); } }
    }
}
