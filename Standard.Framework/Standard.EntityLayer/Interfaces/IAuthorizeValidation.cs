...
namespace Basic.Interfaces
{
	...
	{
		/// <summary>此处禁止改为readonly，因在缓存反序列化中异常。
		/// 子节点没有反序列化</summary>
		...
		/// <summary>子菜单</summary>
		/// <remarks>此处禁止改为readonly，因在缓存反序列化中异常。
		/// 子节点没有反序列化</remarks>
