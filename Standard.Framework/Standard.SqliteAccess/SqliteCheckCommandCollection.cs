...
namespace Basic.SqliteAccess
{
	...
	internal sealed class SqliteCheckCommandCollection : Basic.DataAccess.CheckCommandCollection
	{
		private readonly SqliteStaticCommand ownerCommand;
		/// <summary>
		/// 初始化 SqlCheckCommandCollection 类的新实例。
		/// </summary>
		/// <param name="staticCommand">包含此检测命令集合的静态命令</param>
		public SqliteCheckCommandCollection(SqliteStaticCommand staticCommand) : base(staticCommand) { ownerCommand = staticCommand; }
		...
		public SqliteCheckCommandCollection(SqliteStaticCommand staticCommand, IEnumerable<CheckCommand> collection)
		...
		public SqliteCheckCommandCollection(SqliteStaticCommand staticCommand, List<CheckCommand> list)
		...
		{
			return new SqliteCheckCommand(ownerCommand);
		}
	}
}
