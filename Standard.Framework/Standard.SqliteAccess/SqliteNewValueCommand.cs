...
namespace Basic.SqliteAccess
{
	...
	public sealed class SqliteNewValueCommand : NewValueCommand, ICloneable
	{
		...
		internal SqliteNewValueCommand(SqliteStaticCommand staticCommand)
			: base(staticCommand, new SqliteCommand())
		{
			sqlCommand = dataDbCommand as SqliteCommand;
		...
		private SqliteNewValueCommand(SqliteStaticCommand staticCommand, SqliteCommand sqlCmd)
		...
		/// </summary>
		public SqliteNewValueCommand Clone()
		{
			lock (this)
			{
				SqliteNewValueCommand checkCommand = new SqliteNewValueCommand(dbStaticCommand, sqlCommand.Clone());
		...
		internal SqliteNewValueCommand Clone(SqliteStaticCommand staticCommand)
		{
			lock (this)
			{
				SqliteNewValueCommand newCommand = new SqliteNewValueCommand(staticCommand, sqlCommand.Clone());
