...
namespace Basic.MySqlAccess
{
	...
	internal sealed class MySqlCheckCommandCollection : Basic.DataAccess.CheckCommandCollection
	{
		private readonly MySqlStaticCommand ownerCommand;
		/// <summary>
		/// 初始化 SqlCheckCommandCollection 类的新实例。
		/// </summary>
		/// <param name="staticCommand">包含此检测命令集合的静态命令</param>
		public MySqlCheckCommandCollection(MySqlStaticCommand staticCommand) : base(staticCommand) { ownerCommand = staticCommand; }
		...
		public MySqlCheckCommandCollection(MySqlStaticCommand staticCommand, IEnumerable<CheckCommand> collection)
		...
		public MySqlCheckCommandCollection(MySqlStaticCommand staticCommand, List<CheckCommand> list)
		...
		{
			return new MySqlCheckCommand(ownerCommand);
		}
	}
}
