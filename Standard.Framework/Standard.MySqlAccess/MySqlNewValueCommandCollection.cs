...
{
	/// <summary>
	/// MySqlNewValueCommand 检测命令集合
	/// </summary>
	[System.ComponentModel.EditorBrowsable(EditorBrowsableState.Never), Serializable()]
	internal sealed class MySqlNewValueCommandCollection : NewValueCommandCollection
	{
		...
		public MySqlNewValueCommandCollection(MySqlStaticCommand staticCommand) : base(staticCommand) { dbStaticCommand = staticCommand; }
		...
		public MySqlNewValueCommandCollection(MySqlStaticCommand staticCommand, IList<NewValueCommand> list)
		...
		{
			return new MySqlNewValueCommand(dbStaticCommand);
		}
	}
}
