...
namespace Basic.MySqlAccess
{
	...
	public sealed class MySqlNewValueCommand : NewValueCommand, ICloneable
	{
		...
		internal MySqlNewValueCommand(MySqlStaticCommand staticCommand)
		...
		private MySqlNewValueCommand(MySqlStaticCommand staticCommand, MySqlCommand sqlCmd)
		...
		/// <summary>复制 MySqlNewValueCommand 命令。</summary>
		public MySqlNewValueCommand Clone() { return Clone(dbStaticCommand); }

		/// <summary>
		/// 复制 MySqlNewValueCommand 命令。
		/// </summary>
		internal MySqlNewValueCommand Clone(MySqlStaticCommand staticCommand)
		{
			lock (this)
			{
				MySqlNewValueCommand command = new MySqlNewValueCommand(staticCommand, (MySqlCommand)_MySqlCommand.Clone());
				command.NewType = this.NewType;
				return command;
			}
		}
