...
namespace Basic.EasyLibrary
{
	...
	/// 表示 ComboTree 属性扩展。
	/// </summary>
	public sealed class ComboTreeOptions : ComboOptions, IHtmlAttrs
	{
		/// <summary>
		///  初始化 ComboTreeOptions 类的新实例，该实例为空且具有默认的初始容量，并使用键类型的默认相等比较器。
		/// </summary>
		public ComboTreeOptions() : base() { }
		...
		public ComboTreeOptions(EasyOptions dictionary) : base(dictionary) { }
		...
		/// <exception cref="System.ArgumentNullException">dictionary 为 null。</exception>
		/// <exception cref="System.ArgumentException">dictionary 包含一个或多个重复键。</exception>
		public ComboTreeOptions(IDictionary<string, object> dictionary) : base(dictionary) { }
