...
namespace Basic.EasyLibrary
{
	...
	public sealed class ButtonOptions : EasyOptions, IHtmlAttrs
	{
		...
		/// 为true时显示简洁效果。
		/// </summary>
		public bool plain { set { AddToDataOptions("plain", value ? "true" : "false"); } }
		...
		public ButtonTypeEnum ButtonType { set { AddToDataOptions("buttonType", (int)value); mButtonType = value; } get { return mButtonType; } }
		...
		/// 设置width属性值
		/// </summary>
		public Unit width { set { AddToDataOptions("dWidth", string.Concat("'", value.ToString(), "'")); } }

		/// <summary>
		/// 设置height属性值
		/// </summary>
		public Unit height { set { AddToDataOptions("dHeight", string.Concat("'", value.ToString(), "'")); } }
