...
namespace Basic.MvcLibrary
{
	...
	public sealed class GridView<TM> : Options<GridView<TM>>, IGridView<TM> where TM : class
	{
		...
		public new GridView<TM> Id(string id) { Attr("id", id); return this; }

		/// <summary>设置当前元素的 ref 属性。</summary>
		public new GridView<TM> Ref(string name) { Attr("ref", name); return this; }
		...
		/// <returns>返回当前对象。</returns>
		public GridView<TM> RowKey(string key) { Attr("row-key", key); return this; }
		...
		{
			if (keys != null && keys.Length > 0) { Prop("row-key", string.Concat("['", string.Join("','", keys), "']")); }
			return this;
		}
		...
		/// <returns>返回当前对象。</returns>
		public GridView<TM> Timestamp(string ts) { Attr("timestamp", ts); return this; }
		...
		/// <returns>返回当前对象。</returns>
		public GridView<TM> SetHeight(string height) { Attr("height", height); return this; }

		/// <summary>Table 的高度，默认为自动高度。如果 height 为 number 类型，单位 px；Table 的高度会受控于外部样式。</summary>
		/// <param name="height">要设置的属性新值</param>
		/// <returns>返回当前对象。</returns>
		public GridView<TM> SetHeight(int height) { Attr("height", string.Concat(height, "px")); return this; }

		/// <summary>Table 的最大高度。合法的值为数字或者单位为 px 的高度。</summary>
		/// <param name="height">要设置的属性新值</param>
		/// <returns>返回当前对象。</returns>
		public GridView<TM> SetMaxHeight(string height) { Attr("max-height", height); return this; }

		/// <summary>Table 的最大高度。合法的值为数字或者单位为 px 的高度。</summary>
		/// <param name="height">要设置的属性新值</param>
		/// <returns>返回当前对象。</returns>
		public GridView<TM> SetMaxHeight(int height) { Attr("max-height", string.Concat(height, "px")); return this; }
		...
		public GridView<TM> Action(string action) { Attr("url", basicContext.Action(action, null)); return this; }

		/// <summary>设置执行请求</summary>
		/// <returns>返回当前按钮实例</returns>
		public GridView<TM> Action(string action, string controller) { Attr("url", basicContext.Action(action, controller)); return this; }
		...
		/// <returns>返回当前对象。</returns>
		public GridView<TM> SizeToMedium() { Attr("size", "medium"); return this; }

		/// <summary>Table 的尺寸</summary>
		/// <returns>返回当前对象。</returns>
		public GridView<TM> SizeToSmall() { Attr("size", "small"); return this; }

		/// <summary>Table 的尺寸</summary>
		/// <returns>返回当前对象。</returns>
		public GridView<TM> SizeToMini() { Attr("size", "mini"); return this; }
