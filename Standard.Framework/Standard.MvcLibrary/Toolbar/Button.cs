...
namespace Basic.MvcLibrary
{
	...
	public sealed class Button : Options<Button>
	{
		...
		public Button Icon(string iconCls) { Attr("icon", iconCls); return this; }
		...
		/// <returns>返回当前按钮实例</returns>
		public Button Size(string size) { Attr("size", size); return this; }

		/// <summary>设置为朴素按钮</summary>
		/// <returns>返回当前按钮实例</returns>
		public Button Plain() { Prop("plain", "true"); return this; }

		/// <summary>设置执行请求</summary>
		/// <returns>返回当前按钮实例</returns>
		public Button Action(string action) { Attr("url", mBasic.Action(action, null)); return this; }

		/// <summary>设置执行请求</summary>
		/// <returns>返回当前按钮实例</returns>
		public Button Action(string action, string controller) { Attr("url", mBasic.Action(action, controller)); return this; }
		...
		/// <returns>返回当前按钮实例</returns>
		public Button SetType(string type) { Attr("type", type); return this; }

		/// <summary>设置按钮可用状态</summary>
		/// <param name="status">表示页面状态</param>
		/// <returns>返回当前按钮实例</returns>
		public Button Status(PageStatus status) { Prop("status", (int)status); return this; }

		/// <summary>设置按钮可见状态</summary>
		/// <param name="status">表示页面状态</param>
		/// <returns>返回当前按钮实例</returns>
		public Button Visible(PageStatus status) { Prop("visible", (int)status); return this; }
		...
		internal void Render(TextWriter writer)
		{
			...
			using (TagHtmlWriter builder = new TagHtmlWriter(tagName))
			{
				...
				Prop("btn-type", System.Convert.ToString((int)Type));
