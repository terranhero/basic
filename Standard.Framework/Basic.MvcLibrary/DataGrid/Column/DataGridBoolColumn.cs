...
namespace Basic.EasyLibrary
{
	...
	public class DataGridBoolColumn<T> : DataGridColumn<T, bool> where T : class
	{
		private readonly string TrueText;
		private readonly string FalseText;

		/// <summary>
		/// 初始化EasyBoolColumn列信息
		/// </summary>
		...
		internal protected DataGridBoolColumn(IBasicContext context, string field, Func<T, bool> valueFunc, EntityPropertyMeta metaData, string trueText, string falseText)
