...
using JsonSerializer = Basic.EntityLayer.JsonSerializer;
...
namespace Basic.EasyLibrary
{
	...
	public abstract class DataGridColumn<T> : IDataGridColumn
	{
		...
		public SWUW.Unit Width { get; internal set; }

		/// <summary>用厘米为高度的数字初始化 Height 的新值。</summary>
		/// <param name="width">要设置的属性新值</param>
		/// <returns>返回当前对象。</returns>
		public IDataGridColumn SetWidth(float width) { Width = new SWUW.Unit(width, SWUW.UnitType.Cm); return this; }

		/// <summary>用指定的长度初始化 System.Web.UI.WebControls.Unit 结构的新实例。</summary>
		/// <param name="width">要设置的属性新值</param>
		/// <returns>返回当前对象。</returns>
		public IDataGridColumn SetWidth(string width) { Width = new SWUW.Unit(width); return this; }

		/// <summary>用像素为高度的数字初始化 Width 的新值</summary>
		/// <param name="width">要设置的属性新值</param>
		/// <returns>返回当前对象。</returns>
		public IDataGridColumn SetWidth(int width) { Width = new SWUW.Unit(width); return this; }
