...
namespace Basic.EasyLibrary
{
	...
	public abstract class EasyOptions : Dictionary<string, object>, IHtmlAttrs
	{
		...
		internal protected EasyOptions(EasyOptions dictionary) : base(dictionary)
		{
			_DataOptions = new Dictionary<string, object>(dictionary.DataOptions);
			_StyleOptions = new Dictionary<string, string>(dictionary.StyleOptions);
		}
