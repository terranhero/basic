...
namespace Basic.OracleAccess
{
	...
	public sealed class OracleNewValueCommand : NewValueCommand, ICloneable
	{
		...
		internal OracleNewValueCommand(OracleStaticCommand staticCommand)
		...
		private OracleNewValueCommand(OracleStaticCommand staticCommand, OracleCommand sqlCmd)
		...
		/// </summary>
		public OracleNewValueCommand Clone()
		{
			lock (this)
			{
				OracleNewValueCommand checkCommand = new OracleNewValueCommand(dbStaticCommand, 
		...
		internal OracleNewValueCommand Clone(OracleStaticCommand staticCommand)
		{
			lock (this)
			{
				OracleNewValueCommand newCommand = new OracleNewValueCommand(staticCommand,
					sqlCommand.Clone() as OracleCommand);
