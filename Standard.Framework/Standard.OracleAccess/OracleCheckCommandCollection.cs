...
namespace Basic.OracleAccess
{
	...
	internal sealed class OracleCheckCommandCollection : Basic.DataAccess.CheckCommandCollection
	{
		private readonly OracleStaticCommand ownerCommand;
		/// <summary>
		/// 初始化 SqlCheckCommandCollection 类的新实例。
		/// </summary>
		/// <param name="staticCommand">包含此检测命令集合的静态命令</param>
		public OracleCheckCommandCollection(OracleStaticCommand staticCommand) : base(staticCommand) { ownerCommand = staticCommand; }
		...
		public OracleCheckCommandCollection(OracleStaticCommand staticCommand, IEnumerable<CheckCommand> collection)
		...
		public OracleCheckCommandCollection(OracleStaticCommand staticCommand, List<CheckCommand> list)
		...
		{
			return new OracleCheckCommand(ownerCommand);
		}
	}
}
