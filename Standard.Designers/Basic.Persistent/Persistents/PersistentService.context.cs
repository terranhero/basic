        ...
        private void OnAddPersistent(object sender, EventArgs e)
        {
            ...
            foreach (EnvDTE.UIHierarchyItem uitem in array)
            {
                ...
                else if (uitem.Object is EnvDTE.Project)
                {
                    ...
                    //PersistentForm view = new PersistentForm(this, project, null);
                    //view.ShowModal();
                }
            }
        }

        private void ShowCreatePersistent(EnvDTE.Project project, EnvDTE.ProjectItem item)
        {
            string defaultNamespace, fullPath;
            if (item == null)
            {
                ...
                defaultNamespace = (string)propertyNamespace.Value;
