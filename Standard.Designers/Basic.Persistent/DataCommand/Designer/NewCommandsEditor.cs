...
namespace Basic.Designer
{
	...
	/// 表示验证集合编辑器
	/// </summary>
	public class NewCommandsEditor : CollectionEditor
	{
		/// <summary>
		/// 使用指定的集合类型初始化 NewCommandsEditor 类的新实例
		/// </summary>
		public NewCommandsEditor(Type type) : base(type) { }
		...
		{
			return new Type[] { typeof(DesignerNewCommand) };
		}
