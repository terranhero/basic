...
namespace Basic.Collections
{
	...
	public sealed class CheckedCommandCollection : Basic.Collections.BaseCollection<DesignerCheckedCommand>,
		ICollection<DesignerCheckedCommand>, IEnumerable<DesignerCheckedCommand>, INotifyCollectionChanged
	{
		...
		/// </summary>
		internal CheckedCommandCollection(DesignerStaticCommand element) : base() { staticCommand = element; }
		...
		protected override void InsertItem(int index, Basic.Configuration.DesignerCheckedCommand item)
        {
		...
		protected internal override string GetKey(DesignerCheckedCommand item) { return item.Name; }
	}
}
