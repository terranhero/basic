...
namespace Basic.Configuration
{
	...
	public abstract class DataCommandElement : AbstractCommandElement, IXmlSerializable
	{
		...
		protected internal override void WriteAttribute(System.Xml.XmlWriter writer)
		{
			...
			if (!_AutoGenerated)
				writer.WriteAttributeString(AutoGeneratedAttribute, _AutoGenerated.ToString());
			if (_AsyncGenerated)
				writer.WriteAttributeString(AsyncGeneratedAttribute, _AsyncGenerated.ToString());
