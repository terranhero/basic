    ...
    public partial class ResourceEditor : DataGrid
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (GetTemplateChild("PART_DataGrid") is DataGrid dg)
            {
                ...
                dg.SelectionChanged += new SelectionChangedEventHandler(DataGrid_SelectionChanged);
            }
        }
        ...
        private void DataGrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            foreach (object obj in e.AddedItems) { base.SelectedItems.Add(obj); }
        }
