...
{
	/// <summary>
	/// CreateEnumResource.xaml 的交互逻辑
	/// </summary>
	public partial class CreateEnumResource : Microsoft.VisualStudio.PlatformUI.DialogWindow
	{
		...
		public CreateEnumResource(LocalizationService commandService, EnvDTE80.DTE2 dteClass, LocalizationCollection resources)
		...
		private void Localizations_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
		{
			if (cmbLocalizations.SelectedIndex >= 0)
			{
