...
namespace Basic.Collections
{
	...
	public sealed class TableDesignerCollection : BaseCollection<TableDesignerInfo>
	{
		...
		/// <summary></summary>
		public TableDesignerInfo[] ToArray()
		{
			if (base.Items.Count == 0) { return new TableDesignerInfo[0]; }
			TableDesignerInfo[] tables = new TableDesignerInfo[base.Items.Count + 1];
			base.Items.CopyTo(tables, 0);
			return tables;
		}
