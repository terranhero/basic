...
namespace Basic.Database
{
    ...
    {
        private readonly TransactTableCollection _Tables;
        ...
        /// </summary>
        internal TransactTableInfo(TransactTableCollection tables, string tableName) : this(tables, tableName, tableName) { }

        /// <summary>
        /// 初始化 TransactTableInfo 类实例。
        /// </summary>
        internal TransactTableInfo(TransactTableCollection tables, string tableName, string aliasName)
        {
