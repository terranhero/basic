...
namespace Basic.Database
{
	...
	{
		private readonly TransactSqlResult _results;

		/// <summary>
		/// 初始化 FunctionParameterInfo 类实例。
		/// </summary>
		/// <param name="result">拥有此参数的 AbstractCommandElement 类命令实例。</param>
		internal TransactParameterInfo(TransactSqlResult result)
			: base() { _results = result; }
		...
		public override string GetComponentName() { return typeof(TransactParameterInfo).Name; }
