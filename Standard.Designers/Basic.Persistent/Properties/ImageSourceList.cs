...
namespace Basic.Properties
{
	public static class ImageSourceList
	{
		...
		//public const string database_aggregatefunction.ico
		//public const string database_checkconstraint.ico
		//public const string database_clusteredindex.ico
		//public const string database_column.ico
		//public const string database_component.ico
		//public const string database_computedcolumn.ico
		//public const string database_connection.ico
		//public const string database_datatype.ico
		//public const string database_diagram.ico
		//public const string database_extended.ico
		//public const string database_file.ico
		//public const string database_folder.ico
		//public const string database_foreignkey.ico
		//public const string database_index.ico
		//public const string database_inputparameter.ico
		//public const string database_outputparameter.ico
		//public const string database_primarykey.ico
		//public const string database_returnvalue.ico
		//public const string database_scalarfunction.ico
		//public const string database_storedprocedure.ico
		//public const string database_table.ico
		//public const string database_tabularfunction.ico
		//public const string database_trigger.ico
		//public const string database_uniquekey.ico
		//public const string database_userdefinedtype.ico
		//public const string database_view.ico
		//public const string delete.png
		//public const string execute.png
		//public const string move.cur
		//public const string paste.png
		//public const string properties.png
		//public const string remove.png
		//public const string setting.png
		//public const string thumbnailview.bmp
		//public const string zoom100button.bmp
		//public const string zoominbutton.bmp
		//public const string zoomoutbutton.bmp
	}
}
