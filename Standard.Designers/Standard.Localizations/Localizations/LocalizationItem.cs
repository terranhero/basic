...
namespace Basic.Localizations
{
		 ...
		 IComparable<LocalizationItem>, IEquatable<LocalizationItem>
	{
		...
		/// <summary></summary>
		public const string XmlElementName = "resxData";
		...
		public LocalizationItem(LocalizationCollection localization, string group, string name, string value)
		{
		...
		public void WriteXml(System.Xml.XmlWriter writer, bool writelocalation)
		{
