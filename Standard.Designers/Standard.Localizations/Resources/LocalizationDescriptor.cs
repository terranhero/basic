...
namespace Basic.Designer
{
	...
	internal sealed class LocalizationDescriptor : PropertyDescriptor
	{
		...
		public override string Category
		{
			get
			{
				return DesignerStrings.GetString("LocalizationResource_CultureCategory", CultureInfo.CurrentUICulture);
			}
		}
		...
		public override string Description
		{
			get
			{
				string resource = DesignerStrings.GetString("LocalizationResource_CultureDescription", CultureInfo.CurrentUICulture);
				return string.Format(resource, keyName);
			}
		}
