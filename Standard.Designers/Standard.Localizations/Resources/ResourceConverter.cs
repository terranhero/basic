...
namespace Basic.Designer
{
	...
	/// </summary>
	public sealed class ResourceConverter : TypeConverter
	{
		/// <summary>
		...
		public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
		{
			...
			ObjectDescriptor objectDescriptor = value as ObjectDescriptor;
			if (objectDescriptor != null)
			{
				if (propertyDescriptors == null)
					propertyDescriptors = TypeDescriptor.GetProperties(objectDescriptor.Object, attributes, true);
				List<string> propertyNames = new List<string>(new string[] { "Name", "Value", "Group", "Comment" });
				...
				foreach (KeyValuePair<string, string> keyValue in objectDescriptor.Object)
				{
					properties.Add(new LocalizationDescriptor(keyValue.Key));
				}
			}
			return properties.Sort(new string[] { "Group", "Name", "Value", "Comment" });
		}
