...
namespace Basic.Exceptions
{
	...
	/// </summary>
	[Serializable()]
	public abstract class AbstractCodeException : ApplicationException
	{
		...
		{
			string msg = Strings.ResourceManager.GetString(errorCode);
			if (msg == null)
				return errorCode;
		...
		protected AbstractCodeException(string errorCode) : this(errorCode, null, null) { }
		...
		protected AbstractCodeException(string errorCode, params object[] paramArray) : this(errorCode, null, paramArray) { }
		...
		/// <param name="paramArray">填充错误消息的参数数组</param>
		protected AbstractCodeException(string errorCode, Exception innerException, params object[] paramArray)
		...
		protected AbstractCodeException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
