...
{
	/// <summary>
	/// 表示 ColumnDesignerInfo 类中 Checked 属性已更改的委托参数。
	/// </summary>
	public sealed class ColumnCheckedEventArgs : EventArgs
	{
		...
		public ColumnCheckedEventArgs(ColumnDesignerInfo column) : base() { columnInfo = column; }
	...
	public delegate void ColumnCheckedHandler(object sender, ColumnCheckedEventArgs e);
}
