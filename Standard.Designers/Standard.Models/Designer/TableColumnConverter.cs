...
namespace Basic.Designer
{
    ...
    /// </summary>
    public sealed class TableColumnConverter : TypeConverter
    {
        /// <summary>
        ...
        public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
        {
            ...
            if (propertyDescriptors == null)
                propertyDescriptors = TypeDescriptor.GetProperties(value, attributes, true).Sort(new string[] { "Name", "PropertyName", 
					"DbType", "Size","Precision", "Scale","Nullable" });
            DesignColumnInfo parameter = value as DesignColumnInfo;
            foreach (PropertyDescriptor property in propertyDescriptors)
            {
                ...
                else if (parameter.DbType == DbTypeEnum.Binary || parameter.DbType == DbTypeEnum.VarChar ||
                    parameter.DbType == DbTypeEnum.Char || parameter.DbType == DbTypeEnum.NChar ||
                    parameter.DbType == DbTypeEnum.NVarChar || parameter.DbType == DbTypeEnum.VarBinary)
                {
                    if (property.Name == "Precision" || property.Name == "Scale")
                        continue;
                }
                else if (parameter.DbType == DbTypeEnum.Decimal)
                {
