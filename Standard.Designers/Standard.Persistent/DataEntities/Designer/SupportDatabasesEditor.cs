    ...
    public sealed class SupportDatabasesEditor : System.Drawing.Design.UITypeEditor
    {
        ...
        private class DatabaseListBox : System.Windows.Forms.CheckedListBox
        {
            ...
            public DatabaseListBox()
            {
                ...
                foreach (ConnectionTypeEnum element in Enum.GetValues(typeof(ConnectionTypeEnum)))
                {
                    if (element != ConnectionTypeEnum.Default)
                    {
                        ...
                        indexList.Add(element, base.Items.Count - 1);
                    }
                }
            }
            ...
            internal void BeginEdit(IWindowsFormsEditorService editorService, System.IServiceProvider provider, object value)
            {
                ...
                ConnectionTypeEnum[] list = (ConnectionTypeEnum[])value;
                foreach (ConnectionTypeEnum element in list)
                {
                    base.SetItemChecked(indexList[element], true);
                }
            }
