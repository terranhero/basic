...
namespace Basic.Converters
{
    ...
    /// 表示检测命令集合
    /// </summary>
    internal sealed class ConverterCheckCommandCollection : AbstractCollection<ConverterCheckCommand>
    {
        private readonly ConverterStaticCommand staticCommand;

        /// <summary>
        /// 初始化 ConverterCheckCommandCollection 类的新实例。
        /// </summary>
        internal ConverterCheckCommandCollection(ConverterStaticCommand element) : base(element) { staticCommand = element; }
        ...
        protected internal override string GetKey(ConverterCheckCommand item) { return item.Name; }
        ...
        {
            get { return CheckedCommandCollection.XmlElementName; }
        }
