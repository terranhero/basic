...
{
	/// <summary>
	/// 表示 WithClause 的类型转换器
	/// </summary>
	internal sealed class WithClauseConverter : TypeConverter
	{
		private readonly string[] _Sorted = new string[] { "TableName", "TableDefinition", "TableQuery" };
		/// <summary>
		...
		{
			return TypeDescriptor.GetProperties(value, attributes, true).Sort(_Sorted);
		}
