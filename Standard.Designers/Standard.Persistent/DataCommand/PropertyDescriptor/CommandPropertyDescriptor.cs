...
namespace Basic.Designer
{
	...
	internal sealed class CommandPropertyDescriptor<T> : PropertyDescriptor where T : AbstractCommandElement
	{
		...
		/// <summary>
		/// 初始化 CommandPropertyDescriptor 类实例。
		/// </summary>
		/// <param name="abstractAttribute"></param>
		public CommandPropertyDescriptor(T attribute)
			: base(attribute.ElementName, new Attribute[0]) { _Command = attribute; }
		...
		/// 获取该属性绑定到的组件的类型。
		/// </summary>
		public override Type ComponentType { get { return _Command.GetType(); } }
		...
		public override object GetValue(object component) { return _Command; }
		...
		public override string Category
		{
			get
			{
				if (Attribute.IsDefined(_Command.GetType(), typeof(PersistentCategoryAttribute)))
				{
					PersistentCategoryAttribute pca = (PersistentCategoryAttribute)Attribute.GetCustomAttribute(_Command.GetType(),
		...
		public override string Description
		{
			get
			{
				if (Attribute.IsDefined(_Command.GetType(), typeof(PersistentDescriptionAttribute)))
				{
					PersistentDescriptionAttribute pda = (PersistentDescriptionAttribute)Attribute.GetCustomAttribute(_Command.GetType(),
		...
		public override string DisplayName
		{
			get
			{
				if (Attribute.IsDefined(_Command.GetType(), typeof(DisplayNameAttribute)))
				{
					DisplayNameAttribute dna = (DisplayNameAttribute)Attribute.GetCustomAttribute(_Command.GetType(),
		...
		/// 获取该属性的类型。
		/// </summary>
		public override Type PropertyType { get { return _Command.GetType(); } }
