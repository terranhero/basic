...
namespace Basic.DataContexts
{
    ...
    {
        private readonly MySqlCommand oracleCommand;
        private readonly MySqlConnection oracleConnection;
        internal MySqlDataContext(string connectionString)
        {
            oracleConnection = new MySqlConnection(connectionString);
            oracleConnection.Open();
            oracleCommand = new MySqlCommand(string.Empty, oracleConnection);
        }
