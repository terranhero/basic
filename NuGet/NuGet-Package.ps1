...
if(Test-Path $path"\NuGet.exe")
{
    ...
    Write-Host "Successfully copied package $binPath\Standard.SqlClientAccess.$version.nupkg"
    ...
    Write-Host "Successfully copied package $binPath\Standard.PostgreAccess.$version.nupkg"	
	
	copy-item "$binPath\Standard.OracleAccess.$version.nupkg" -destination $packagePath
    Write-Host "Successfully copied package $binPath\Standard.OracleAccess.$version.nupkg"
